...
public class Recommend_New_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(Recommend_New_Activity.this,date,myCalen.get(Calendar.YEAR), myCalen.get(Calendar.MONTH),
