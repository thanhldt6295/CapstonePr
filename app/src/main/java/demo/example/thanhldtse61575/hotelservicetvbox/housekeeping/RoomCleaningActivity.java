    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFinalize.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                list.add(new CartItem(24,"Room clean",47,0,"","",1,cmt));
                new AlertDialog.Builder(RoomCleaningActivity.this)
...
//                                                    deliveryTime.getHour(), deliveryTime.getMinute(), 0);
        ...
        txtDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(RoomCleaningActivity.this,date,myCalen.get(Calendar.YEAR), myCalen.get(Calendar.MONTH),
